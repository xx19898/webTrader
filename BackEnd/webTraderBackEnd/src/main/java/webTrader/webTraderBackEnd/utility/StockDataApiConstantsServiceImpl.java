...
public class StockDataApiConstantsServiceImpl implements StockDataApiConstantsService{
	...
	public int getMaxLimitOfStockApiCallsTimeLimit() { return this.MAX_LIMIT_OF_STOCK_API_CALLS_PER_TIME_LIMIT; }
	public int getTimeLimitInSeconds() { return this.TIME_LIMIT_IN_SECONDS; }
