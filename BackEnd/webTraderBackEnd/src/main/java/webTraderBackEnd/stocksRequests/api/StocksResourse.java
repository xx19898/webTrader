...
public class StocksResourse{
	...
	(@RequestParam String function, @RequestParam List<String> symbols, @RequestParam Optional<String> interval) throws StockRequestHandlerChainException, IOException{
